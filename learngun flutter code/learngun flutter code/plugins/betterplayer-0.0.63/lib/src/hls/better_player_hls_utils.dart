...
class BetterPlayerHlsUtils {
  ...
  static Future<List<BetterPlayerHlsTrack>> parseTracks(String data, String masterPlaylistUrl) async {
  ...
  static Future<List<BetterPlayerHlsSubtitle>> parseSubtitles(String data, String masterPlaylistUrl) async {
  ...
  static Future<List<BetterPlayerHlsAudioTrack>> parseLanguages(String data, String masterPlaylistUrl) async {
