...
class _ZoomableChildState extends AnimatedWidgetBaseState<_ZoomableChild> {
  ...
  void forEachTween(TweenVisitor<dynamic> visitor) {
    ...
    _panOffset =
        visitor(_panOffset, widget.panOffset, (dynamic value) => OffsetTween(begin: value as Offset?)) as OffsetTween?;
    _rotation =
        visitor(_rotation, widget.rotation, (dynamic value) => DoubleTween(begin: value as double?)) as DoubleTween?;
  }
